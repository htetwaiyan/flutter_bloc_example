class News {
  ...
  News({this.status, this.feed, this.items});
...
class Items {
  ...
  Items({this.title, this.pubDate, this.link, this.guid, this.author, this.thumbnail, this.description, this.content, this.categories});
